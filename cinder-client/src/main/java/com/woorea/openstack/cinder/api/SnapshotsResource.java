...
public class SnapshotsResource {
	...
	public class Create extends OpenStackRequest<SnapshotForCreate> {
		...
		public Create(SnapshotForCreate snapshotForCreate) {
			super(CLIENT, HttpMethod.POST, "/snapshots", Entity.json(snapshotForCreate), SnapshotForCreate.class);
	...
	public class ShowMetadata extends OpenStackRequest<Metadata> {
		...
		public ShowMetadata(String id) {
			super(CLIENT, HttpMethod.GET, new StringBuilder("/snapshots/").append(id).append("/metadata").toString(), null, Metadata.class);
		}
